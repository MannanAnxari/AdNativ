...
const services = [
  ...
  [
    ...
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M10 6V10L13 13" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
    ...
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <rect x="2.5" y="5.5" width="15" height="10" rx="1" stroke="#126ad2" strokeWidth="2" />
        </svg>
      ),
    ...
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M10 2.5V17.5" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
          <path
      ...
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            strokeWidth="2"
          />
          <path d="M6 8.5H14" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
          <path d="M6 11.5H12" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
  ...
  [
      ...
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            strokeWidth="2"
          />
          <path d="M10 6V10H14" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
      title: "Performance marketing",
      description: "Focus on measurable results to optimize your marketing spend and maximize ROI.",
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M2.5 5L10 10L17.5 5" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path
    ...
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="2.5" y="2.5" width="15" height="15" rx="2" stroke="#126ad2" strokeWidth="2" />
          <path d="M6 10H14" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
          <path d="M10 6V14" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
      title: "Mobile app development",
      description: "Create native and cross-platform mobile applications that engage users on the go.",
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            strokeWidth="2"
          />
          <path d="M7.5 7.5L12.5 12.5" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
          <path d="M12.5 7.5L7.5 12.5" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
    ...
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M5 5L15 15" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M15 5L5 15" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ),
      ...
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M2.5 10L10 14.1667" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ),
      title: "Video production",
      description: "Create engaging video content that tells your brand story and drives engagement across channels.",
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            strokeWidth="2"
          />
          <path d="M7.5 10H12.5" stroke="#126ad2" strokeWidth="2" strokeLinecap="round" />
        </svg>
      ),
