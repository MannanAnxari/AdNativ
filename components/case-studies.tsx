      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="case-study-metric">
            ...
            <p className="text-gray-600 mb-4">
              We helped this brand achieve a 72% increase in sales through
              strategic ad campaigns while maintaining a healthy 3.5x return on
              ad spend.
            </p>
            ...
            <div className="flex justify-between items-center">
              <div>
                <span className="font-bold">3.5x</span>{" "}
          ...
          <div className="case-study-metric">
            <div className="flex justify-between items-center mb-4">
              <div>
                <h3 className="text-xl font-bold">
                  How Creative Ads Drove 4% Conversion Rate for a Mature Kitchen
                  Brand
                </h3>
              </div>
              <div className="green-dot"></div>
            ...
            <p className="text-gray-600 mb-4">
              Our creative ad strategies helped this mature kitchen brand
              achieve a 4% conversion rate, significantly above the industry
              average.
            </p>
            <div className="metric-chart">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="case-study-metric">
            ...
            <p className="text-gray-600 mb-4">
              Our DSP (Demand-Side Platform) campaign strategy helped this
              product reach the #1 position in Amazon search results.
            </p>
            <div className="metric-chart">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <span className="text-gray-500">Search Position</span>
              </div>
              <a
                href="#"
                className="text-sm font-medium text-purple-600 flex items-center"
          ...
          <div className="case-study-metric">
            ...
            <p className="text-gray-600 mb-4">
              We helped this client reach 100% of their sales target in just 10
              days and doubled their desired return on ad spend.
            </p>
            <div className="metric-chart">
              <div
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <span className="text-gray-500">Target ROAS</span>
              </div>
              <a
                href="#"
                className="text-sm font-medium text-purple-600 flex items-center"
